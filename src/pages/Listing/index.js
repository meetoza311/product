            ...
            allMenuItems?.length !== 0 &&
                allMenuItems.map((item, index) => {
                    ...
                    if (props.single === true) {
                        ...
                        if (item.path_name.toLowerCase() == id.toLowerCase()) {
                            console.log(item, id)
                            item.items.length !== 0 &&
                ...
                <div className='container-fluid'>

                    {
                        <div className='breadcrumb flex-column'>
                            <h1 className="text-capitalize">{id.split('_').join(' ')}</h1>
                    ...
                    <div className='listingData'>
                        <div className='row'>
                            <div className={`col-md-3 sidebarWrapper ${context.isOpenFilters === true && 'click'}`}>
                                ...
                                {
                                    allMenuItems.length !== 0 && <Sidebar data={allMenuItems} currentCatData={allMenuItems} filterByBrand={filterByBrand} filterByPrice={filterByPrice} filterByRating={filterByRating} />
                                }
                            ...
                            <div className='col-md-9 rightContent homeProducts pt-0'>
                                ...
                                {/* <div className='topStrip d-flex align-items-center'>
                                    <p className='mb-0'>We found <span className='text-success'>{filterdata?.length}</span> items for you!</p>
                                ...
                                <div className='search'>
                                    <input type='text' placeholder='Search for items...' onChange={(e) => searchItem(e)} />
